...
def find_most_common_cooccurring_hashtag(tweet_data, hashtag_to_ignore):
    ...
    #print out the top three in order for FUN 
    x = 1
    print('\n The top three most common co-occuring hashtags with', hashtag_to_ignore, 'are:')
    
    #sorted_hashtag_count = sorted(hashtag_count, key=hashtag_count.get, reverse = True)
    #most_common_hashtags = sorted_hashtag_count.most_common()
